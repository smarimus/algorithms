...
public class SubSetString {
	...
	static void printSubsetsWithGivenSum(int[] array, int i, int[]output, int k) {
		if (i == array.length){
		...
		printSubsetsWithGivenSum(array, i+1, output, k);
		output[k] = array[i]; 
		printSubsetsWithGivenSum	(array, i+1, output, k+1);
	}
	...
	static void print(int[] output, int k){
		//Print output[0...k-1]
		for (int z = 0; z < k; z++) {
			System.out.print("" + output[z] + " ");
		}
