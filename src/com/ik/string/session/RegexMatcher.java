...
public class RegexMatcher {
    ...
    private static boolean stringMatching(String r, int i, String s, int j) {
        ...
        System.out.print("pattern: "); print(r, i, r.length()); System.out.print("---  Str: "); print(s, j, s.length());
        System.out.println();
        
        if (i + 1 < r.length() && r.charAt(i + 1) == '*'){
        	//System.out.println(r.charAt(i) == s.charAt(j));
    ...
    private static void print(String s, int start, int end){
